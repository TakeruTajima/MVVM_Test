...
import com.mr2.mvvm_test.sample.domain.outside.product.ProductRepository;
...
public class ProductRepositoryImpl implements ProductRepository {
    ...
    public void save(Product product) {
        com.mr2.mvvm_test.sample.infra.Product roomEntity = new com.mr2.mvvm_test.sample.infra.Product(
        ...
        List<com.mr2.mvvm_test.sample.infra.Product> productList = productDao.findById(roomEntity._id);
    ...
    public Product findOne(ProductId productId) {
        List<com.mr2.mvvm_test.sample.infra.Product> productList = productDao.findById(productId.id());
        if (1 < productList.size()) throw new IllegalStateException();
        if (productList.isEmpty()) return null;
        com.mr2.mvvm_test.sample.infra.Product p = productList.get(0);
        return new Product(
                p.unmutated_version,
